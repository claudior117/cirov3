      ...
      <div class="container mb-3 " >
            ...
            <div class="row">
              <div class="col mb-3 LineaTituloP d-flex justify-content-end">
                <strong>Estado de Cuenta por profesionales</Strong> 
              </div>
            </div>  
           ...
           <div class="row ">
            ...
            <div class="col-1 d-flex justify-content-end ">
                        <a class="btn_mc_mini_volver align-middle" href="javascript:window.history.go(-1)" id="idBtvolver" data-toggle="tooltip" data-placement="top" title="Volver"><i class="bi bi-box-arrow-in-left"></i></a>
            </div>
