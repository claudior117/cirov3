...
<body>
                    ...
                    <?php
                          ...
                          echo("<tr class='align-middle'> <td></td><td></td><td></td><td></td> 
                          ...
                          <td></td>
                          <td style='text-align: right;'><b>". number_format($retenciones,2,".","") . "</b></td>
                          </tr>");

                          echo("<tr class='align-middle'> <td></td><td></td><td></td><td></td> 
                          <td class='text-end'><b>TOTAL</b></td> 
                          <td></td>
                          <td style='text-align: right;'><b>". number_format($subtotal - $retenciones,2,".","") . "</b></td>
                          </tr>");
