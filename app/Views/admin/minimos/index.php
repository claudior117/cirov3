      ...
      <div class="container" data-aos="fade-up">
            <div class="row">
              <div class="col mb-1 mx-3 LineaTituloP d-flex justify-content-end">
                Panel Administrador de Aranceles Mínimos :  
              </div>
            </div>  
            ...
            <div class="row">
              <div class="col-2 d-flex align-items-center">
                        ...
                        <a class="btn_mc_mini_file" id="idBtAgregar" href="<?=site_url();?>MinActuXls" data-toggle="tooltip" data-placement="top" title="Actualizar desde Excel"><i class="bi bi-filetype-xls"></i></a>
