  ...
  <section id="about" class="about">
      ...
      <div class="container" data-aos='fade-up' >
            <div class="row">
              <div class="col mb-1 mx-3 LineaTituloP d-flex justify-content-end">
                Aranceles Mínimos: Modificar datos  
              </div>
            </div>         
      ...
      <div class="container">
        <div class="row">
            <div class="col-1"></div>
            <div class="col-9">
            <form action="<?=site_url('/MinGuardar/U');?>" method="POST">
              ...
              <div class="form-group"> 
                <label for="idArancel" class="control-label fs-6">Arancel:</label>
                <input type="number" class="form-control" id="idArancel" name="nameArancel" value='<?= $arregloItems['arancel']; ?>'>
                <div><p class="text-danger"><small><?=session('errors.nameArancel');?></small></p> </div>
              </div>    
...
<script src="<?= base_url(); ?>public/js/min/min.js"></script>
