  ...
  <section id="about" class="about">
      ...
      <div class="container" data-aos='fade-up' >
            <div class="row">
              <div class="col mb-1 mx-3 LineaTituloP d-flex justify-content-end">
                Actualización de Aranceles desde Excel
              </div>
            </div>         
      ...
      <div class="container">
        <div class="row">
          ...
          <!-- formulario -->
          <form action="<?=site_url('/ProcesaXls');?>" method="POST" enctype="multipart/form-data">
           
          <div class="row my-5"> <!--Obra social-->
            <div class="col-1"></div>
            <div class="col-9"> 
                  <div class="mb-3">
                    <label for="IdSelOs" class="form-label">Obra Social </label>
                    <select id="IdSelOs" name="nameIdOs"class="form-select form-select-sm" aria-label=".form-select-sm example">
                          <option value="0">Mínimos Odontológicos</option>
                          
                    </select>
                    <div><p class="text-danger"><small><?=session('errors.nameIdOs');?></small></p> </div>
