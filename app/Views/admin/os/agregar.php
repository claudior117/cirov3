  ...
  <section id="about" class="about">
      ...
      <div class="container">
        <div class="row">
            <div class="col-1"></div>
            <div class="col-9">
            <form action="<?=site_url();?>OsGuardar/I" method="POST">
              <div class="form-group"> 
                <label for="idOs" class="control-label fs-6">Obra Social:</label>
                <input type="text" class="form-control" id="idOs" name="nameOs" placeholder="Ingresar aquí el nombre de la Obra social">
