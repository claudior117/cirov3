  ...
  <section id="about" class="about">
      ...
      <div class="container" data-aos='fade-up' >
            <div class="row">
              ...
              ¡¡ATENCION: Está por eliminar de forma permanente una Obra Social de la Base de datos y todos sus elementos relacionados. Realize esta operación con responsabilidad!!!
              </div>
            </div> 
      ...
      <div class="container">
        <div class="row">
            <div class="col-1"></div>
            <div class="col-9">
            <form id="FormularioCrud" action="<?=site_url();?>'OsGuardar/D'" method="POST">
