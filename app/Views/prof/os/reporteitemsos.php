...
$lineasHoja = 55;
$GLOBALS['titulo'] ="ARANCELES OBRA SOCIAL: ";
$GLOBALS['pagina'] = 1;


function nuevaHoja($idosH, $osH){
  $lineas = 0;
...
<table style="width:90%; margin:auto;">
 <tr>
   <td><p style="font-size:16px;"><strong>'.$GLOBALS['titulo']. "(" .$idosH . ")" . $osH . '<strong></p></td>
 </tr>
</table>
  ...
  <td style="text-align:end;">Coseguro</td>
  <td style="text-align:end;">Actualizacion</td>
  </tr>
                    ...
                    if ($GLOBALS['pagina']==1){
                      ...
                      align-items: center; justify-content: center;">ATENCIÓN:Para imprimir utilice CTRL + P </div>');
                            ...
                            foreach ($arregloItems as $valores){
                                ...
                                echo("<td style='text-align: right;'>". number_format($valores['precio'],2,".",""). "</td>");
                                echo("<td style='text-align: right;'>". number_format($valores['coseguro'],2,".",""). "</td>");
                            ...
                            echo("<td></td>");
                            echo("<td></td>");
                            echo("<td style='margin:10 0 10 0'><b>Cantidad de Items: ". $i ."</b></td>");
                            echo("<td></td>");
                            echo("<td> </td>");
                            echo("<td> </td>");
                            echo("</tr>");
