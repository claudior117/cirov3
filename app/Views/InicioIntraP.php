...
<!--<div class="container">-->
   ...
   <div class="row">   
     <div class="col">
       ...
       <a id="idBtnMsj" class="btn btn-sm btn-outline-warning ms-3" data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
                  Mensajes
         </a>
...
<div class="container position-absolute top-10">
  ...
  <div class="card-body">
  <div class="row ">
      <div class="col mb-3 fs-6 text-end fw-light">
        <label for="idaño">Año:</label>
        <input class="fw-light" type="number" id="idaño">
      </div>
  </div>    
    ...
    <div class="col-4">
      ...
      <div class="col-4" >
        <div style="height:200px;">
            <canvas id="idChartLiq3"></canvas>
        </div>       
    </div>  
    <!--gráficos -->
     <div class="col-4">
        <div style="height:200px;">
            <canvas id="idChartLiq2"></canvas>
        </div>       
      </div>    
  </div> <!-- fin row-->
